 ...
 * @author yanisinfo
 */
public class AnisController implements Initializable {
    ...
    private void GestMed(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/pidev/gui/Medecin.fxml"));
    ...
    private void GestDos(ActionEvent event) throws IOException {
        System.out.println(" Retour ");
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/pidev/gui/DossierMedical.fxml"));
        Parent root = loader.load();
        container_client.getChildren().setAll(root);
    ...
    private void GoToConsu(ActionEvent event) throws IOException {
        System.out.println(" Retour ");
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/pidev/gui/Consultation.fxml"));
        Parent root = loader.load();
        container_client.getChildren().setAll(root);
