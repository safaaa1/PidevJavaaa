...
public class CoursController  implements Initializable {
    ...
    @FXML
    private TableColumn<Cours, Integer> colcl;

    @FXML
    private TableColumn<Cours, Integer> colens;

    @FXML
    private TableColumn<Cours, Integer> colenf;
  ...
  public ObservableList<Cours> data=FXCollections.observableArrayList();
    ...
    colcl.setCellValueFactory(new PropertyValueFactory<Cours,Integer>("idcl"));
    ...
    colenf.setCellValueFactory(new PropertyValueFactory<Cours,Integer>("idenfant"));
    colens.setCellValueFactory(new PropertyValueFactory<Cours,Integer>("idenseignant"));
    ...
    try{
        ...
        while(rs.next()){
        data2.add(new Enseignant(rs.getInt(1),rs.getInt(2), rs.getString(3),rs.getString(4),rs.getString(5),rs.getInt(6) ));
