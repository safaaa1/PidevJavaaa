...
import pidev.controller.SeConnecterParentController;
 ...
 * @author safa
 */
public class SinscrireParentController implements Initializable {
    @FXML
    ...
    private void controlPrenom(KeyEvent event) {
     ...
     @FXML
    public void sinscrireParent(ActionEvent actionEvent) throws IOException {
        if (verificationNom == false) {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/pidev/gui/seConnecterParent.fxml"));
            Parent root = loader.load();
            SeConnecterParentController seConnecterParentController = loader.getController();
