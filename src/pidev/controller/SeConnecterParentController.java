 ...
 * @author safa
 */
public class SeConnecterParentController implements Initializable {
    ...
    public void connecter(ActionEvent actionEvent) throws SQLException, IOException {
        ...
        String responsable= "a:1:{i:0;s:11:\"ROLE_CLIENT\";}";
        ...
        if (mdpCrypte == true) {
           ...
           if(testRole.equals(responsable)){
               FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/pidev/gui/EventFront.fxml"));
    ...
    public void sinscrire(ActionEvent actionEvent) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/pidev/gui/sinscrireParent.fxml"));
        Parent root = loader.load();
        SinscrireParentController sinscrireController = loader.getController();
